...
Feature: Verify GoREST API POST request to create new user with invalid "email" parameter
  ...
  Scenario: Create new user with empty email
    ...
    And I set "{\"name\":\"Allasani Peddana\", \"email\":\"invalid\", \"status\":\"active\", \"gender\":\"male\"}" as request body
